...
import {
  handleUserUploadBatchStageRequest,
  handleInternalUploadBatchRequest,
  isUserUploadBatchStagePath
} from "./upload-batch-stage-api.mjs";
  ...
  async fetch(
    ...
    try {
      ...
      if (
        ...
        return await handleInternalUploadBatchRequest(
          request,
          env
        );
      ...
      if (
        ...
        return await serveProtectedAsset(
          request,
          env,
          ctx,
          ownerAsset,
